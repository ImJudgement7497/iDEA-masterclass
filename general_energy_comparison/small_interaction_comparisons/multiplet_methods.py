...
# def get_energy(energy_method, max_k, max_index=20):
...
#         up_index = indices[i][0][0]
#         down_index = indices[i][1][0]
#         energy.append(energy_method(up_index) + energy_method(down_index))
#     energy_index_arr = np.argsort(energy,kind='stable')
    
#     energy_indices = energy_index_arr[:max_k]
#     summary = []
#     for index in energy_indices:
#         summary.append([indices[index][0][0], indices[index][1][0], energy[index]])
